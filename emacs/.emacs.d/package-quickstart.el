...
(let ((load-file-name "/Users/laurynas/.emacs.d/elpa/all-the-icons-dired-20211007.57/all-the-icons-dired-autoloads.el"))

(add-to-list 'load-path (directory-file-name
                         (or (file-name-directory "/Users/laurynas/.emacs.d/elpa/all-the-icons-dired-20211007.57/all-the-icons-dired-autoloads.el") (car load-path))))

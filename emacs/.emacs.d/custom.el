...
(custom-set-variables
 ...
 '(package-selected-packages
   '(org-roam fancy-compilation tree-sitter tree-sitter-langs org-contrib flycheck-status-emoji flycheck-google-cpplint rainbow-delimiters gitattributes-mode gitconfig-mode gitignore-mode git-messenger beginend cheat-sh info-colors grab-mac-link color-identifiers-mode stripe-buffer flycheck-color-mode-line beacon lua-mode helm-icons neuron-mode wgrep-helm wgrep lsp-treemacs s calfw-ical calfw calfw-org helm-make gcmh which-key keyfreq helm-dash helm-org helm-lsp helm-descbinds helm-projectile helm company-box yasnippet iedit modern-cpp-font-lock highlight-indent-guides page-break-lines xterm-color eldoc-cmake projectile vterm deadgrep all-the-icons-dired rich-minority git-gutter-fringe aggressive-indent lsp-ui lsp-mode company flycheck dispwatch org-analyzer undo-tree yaml-mode markdown-mode ssh ssh-config-mode bison-mode org-plus-contrib cmake-font-lock cmake-mode google-c-style solarized-theme wakatime-mode exec-path-from-shell magit org))

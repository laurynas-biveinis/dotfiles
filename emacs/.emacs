...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (git-gutter-fringe aggressive-indent company-lsp lsp-ui lsp-mode company flycheck auto-indent-mode dispwatch org-analyzer undo-tree yaml-mode markdown-mode linum-off po-mode ssh ssh-config-mode bison-mode org-plus-contrib cmake-font-lock cmake-mode google-c-style solarized-theme wakatime-mode exec-path-from-shell autopair magit org auctex)))

...
export MY8026="$CMAKE_COMMON $CMAKE_RELEASE $MY80_COMMON $MY80026_EXTRA"
export MY8026D="$CMAKE_COMMON $CMAKE_DEBUG -DWITH_DEBUG=ON -DWITH_INNODB_EXTRA_DEBUG=ON -DDEBUG_EXTNAME=OFF $MY80_COMMON $MY80026_EXTRA"
